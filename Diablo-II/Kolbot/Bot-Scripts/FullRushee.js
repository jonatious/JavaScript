function FullRushee() {
	...
	while (true) {
		...
		{
			case 0:
				object.counter[object.counter.length - 1] = 1;
				break;
			case 1:
				object.counter[object.counter.length - 1] = 2;
				break;
			case 2:
				object.counter[object.counter.length - 1] = 3;
				break;
		}
		...
		case "ready":
			...
			if (!quester) {
				if (leader.area == 49 || leader.area == 60 || ((leader.area == 120 || leader.area == 132) && me.level >= 40)) {
					continue;
				}else {
					break;
				}
